...
def open_dashboard(username):
    ...
    tk.Label(dashboard, text=f"Welcome, {username}!", font=TITLE_FONT, bg=BG_COLOR, fg=FG_COLOR).pack(pady=30)
    logout_btn = tk.Button(dashboard, text="Logout", command=dashboard.destroy, width=BTN_WIDTH, bg=BTN_COLOR, fg=FG_COLOR, font=FONT, relief="flat")
...
def forgot_password():
    ...
    username_entry = tk.Entry(fp_frame, bg=ENTRY_BG, fg=FG_COLOR, font=FONT, insertbackground=FG_COLOR)
